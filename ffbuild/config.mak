...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/e/CloudMusic/Cache/ffmpeg_build --disable-static --enable-shared --enable-pic --disable-symver --disable-debug --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-optimizations --disable-stripping --enable-gpl --enable-nonfree --enable-cross-compile --disable-yasm --enable-small --enable-version3 --enable-asm --disable-x86asm --enable-openssl --enable-sdl2 --disable-encoders --enable-encoder=aac --enable-libfdk-aac --enable-encoder=libx264 --enable-libx264 --enable-encoder=libx265 --enable-libx265 --disable-decoders --enable-decoder=aac --enable-decoder=h264 --enable-decoder=hevc --disable-demuxers --enable-demuxer=aac --enable-demuxer=mov --enable-demuxer=mpegts --enable-demuxer=flv --enable-demuxer=h264 --enable-demuxer=hevc --enable-demuxer=hls --disable-muxers --enable-muxer=h264 --enable-muxer=flv --enable-muxer=f4v --enable-muxer=mp4 --enable-muxer=mpegts
...
CFLAGS=   -std=c11  -IE:/CloudMusic/Cache/thrid_party/build/aac_install/include -DX264_API_IMPORTS -IE:/CloudMusic/Cache/thrid_party/build/x264_install/include -IE:/CloudMusic/Cache/thrid_party/build/x265_install/include -IE:/CloudMusic/Cache/thrid_party/build/ssl_install/include  -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized -IE:/CloudMusic/Cache/thrid_party/build/sdl_install/include -IE:/CloudMusic/Cache/thrid_party/build/sdl_install/include/SDL2
...
CFLAGS-ffplay=-Dmain=SDL_main -IE:/CloudMusic/Cache/thrid_party/build/sdl_install/include -IE:/CloudMusic/Cache/thrid_party/build/sdl_install/include/SDL2
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lpsapi -lole32 -lstrmiids -luuid -loleaut32 -lshlwapi -lgdi32 -lm -latomic -lvfw32 -LE:/CloudMusic/Cache/thrid_party/build/sdl_install/lib -lmingw32 -lSDL2main -lSDL2
EXTRALIBS-avfilter=-lm -latomic
EXTRALIBS-swscale=-lm -latomic
EXTRALIBS-postproc=-lm -latomic
EXTRALIBS-avformat=-lm -latomic -lz -LE:/CloudMusic/Cache/thrid_party/build/ssl_install/lib -lssl -lcrypto -lws2_32
EXTRALIBS-avcodec=-liconv -lm -latomic -LE:/CloudMusic/Cache/thrid_party/build/x264_install/lib -lx264 -LE:/CloudMusic/Cache/thrid_party/build/x265_install/lib -lx265 -lole32 -luser32
EXTRALIBS-swresample=-lm -latomic
EXTRALIBS-avutil=-lm -LE:/CloudMusic/Cache/thrid_party/build/ssl_install/lib -lssl -lcrypto -luser32 -lbcrypt -latomic
EXTRALIBS-ffplay=-LE:/CloudMusic/Cache/thrid_party/build/sdl_install/lib -lmingw32 -lSDL2main -lSDL2 -lshell32
